...
const categories = {
  ...
  'files': ['file', 'folder', 'document', 'paper', 'clipboard', 'note', 'archive', 'box', 'briefcase'],
...
fs.writeFileSync('src/data/fontawesome-icons-new.ts', output);
console.log('\nGenerated fontawesome-icons-new.ts');
console.log('\nIcons by category:');
